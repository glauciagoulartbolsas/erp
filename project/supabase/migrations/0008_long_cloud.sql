/*
  # Fix Product Variations and Photos Schema
...
-- Drop existing policies to avoid conflicts
DROP POLICY IF EXISTS "variations_select_policy" ON product_variations;
DROP POLICY IF EXISTS "variations_insert_policy" ON product_variations;
DROP POLICY IF EXISTS "variations_update_policy" ON product_variations;
DROP POLICY IF EXISTS "variations_delete_policy" ON product_variations;
...
-- Create policies for variations with unique names
CREATE POLICY "variations_select_policy_v2"
...
CREATE POLICY "variations_insert_policy_v2"
...
CREATE POLICY "variations_update_policy_v2"
...
CREATE POLICY "variations_delete_policy_v2"
...
-- Create policies for photos with unique names
...
CREATE INDEX IF NOT EXISTS idx_product_variations_product_id_v2 ON product_variations(product_id);
CREATE INDEX IF NOT EXISTS idx_product_photos_product_id_v2 ON product_photos(product_id);
CREATE INDEX IF NOT EXISTS idx_product_photos_variation_id_v2 ON product_photos(variation_id);